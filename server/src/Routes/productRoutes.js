...
const {createProduct, getProducts, getProductsDashboard, deleteProduct, updateStatusProducts, getMarketPlaceProducts, getProductById, getPendingProducts, EditProduct } = require("../Controller/productController");
...
router.get("/productDashboard", apiLimiter, auth, getProductsDashboard);
